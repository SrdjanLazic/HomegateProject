    ...
    return (
        <div className={"container"}>
            <div className={"images-slideshow"}>
                <img src={"https://media2.homegate.ch/f_auto/t_web_dp_small/listings/n070neuse/3002124817/image/6c2b8ef472c19d16d51f4bd33553a0de.jpg"}></img>
            </div>
            <div className={"description"}>
                <h1>Description</h1>
                <h3>"Durchdachte 6½-Zimmer Eigentumswohnung an der Segantinistrasse 174"</h3>
                <div>
